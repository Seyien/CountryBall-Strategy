...
namespace GridStrategy.Tests.EditMode.Combat
{
    public sealed class HealingRulesTests
    {
        ...
        [TestCase(90, 100, 30, ExpectedResult = 100)]   // üst kelepçe
        ...
        {
            // Alternatif: try/catch + boş catch. Seçilmedi: doğrulama bir gün
            // silinirse metot fırlatmaz, catch hiç çalışmaz ve test SESSİZCE
            // yeşil verir — Assert.Throws ise fırlatma yoksa testi düşürür.
